...
class Resume(models.Model):
    ...
    email = models.EmailField(max_length=255, blank=True, verbose_name='邮箱')
    apply_position = models.CharField(max_length=255, blank=True, verbose_name='应聘职位')
    born_address = models.CharField(max_length=255, blank=True, verbose_name='生源地')
    ...
    # attachment = models.FileField(upload_to='files/', blank=True, verbose_name='简历附件')

    # 学校与学历信息
    bachelor_school = models.CharField(max_length=255, blank=True, verbose_name='本科学校')
    master_school = models.CharField(max_length=255, blank=True, verbose_name='研究生学校')
    doctor_school = models.CharField(max_length=255, blank=True, verbose_name='博士生学校')
    major = models.CharField(max_length=255, blank=True, verbose_name='专业')
    degree = models.CharField(max_length=255, choices=DEGREE_TYPE, blank=True, verbose_name='学历')
