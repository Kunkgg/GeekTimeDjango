...
class Candidate(models.Model):
    ...
    candidate_remark = models.CharField(
        max_length=135, blank=True, verbose_name="候选人信息备注"
    )
    ...
    test_score_of_general_ability = models.DecimalField(
        decimal_places=1, null=True, max_digits=3, blank=True, verbose_name="综合能力测评成绩"
    )
    paper_score = models.DecimalField(
        decimal_places=1, null=True, max_digits=3, blank=True, verbose_name="笔试成绩"
    )
    ...
    first_learning_ability = models.DecimalField(
        decimal_places=1, null=True, max_digits=2, blank=True, verbose_name="学习能力得分"
    )
    first_professional_competency = models.DecimalField(
        decimal_places=1, null=True, max_digits=2, blank=True, verbose_name="专业能力得分"
    )
    ...
    second_pursue_of_excellence = models.DecimalField(
        decimal_places=1, null=True, max_digits=2, blank=True, verbose_name="追求卓越得分"
    )
    second_communication_ability = models.DecimalField(
        decimal_places=1, null=True, max_digits=2, blank=True, verbose_name="沟通能力得分"
    )
    second_pressure_score = models.DecimalField(
        decimal_places=1, null=True, max_digits=2, blank=True, verbose_name="抗压能力得分"
    )
    ...
    second_result = models.CharField(
        max_length=256, choices=INTERVIEW_RESULT_TYPE, blank=True, verbose_name="专业复试结果"
    )
    ...
    hr_score = models.CharField(
        max_length=10, choices=HR_SCORE_TYPE, blank=True, verbose_name="HR复试综合等级"
    )
    hr_responsibility = models.CharField(
        max_length=10, choices=HR_SCORE_TYPE, blank=True, verbose_name="HR责任心"
    )
    hr_communication_ability = models.CharField(
        max_length=10, choices=HR_SCORE_TYPE, blank=True, verbose_name="HR坦诚沟通"
    )
    hr_logic_ability = models.CharField(
        max_length=10, choices=HR_SCORE_TYPE, blank=True, verbose_name="HR逻辑思维"
    )
    hr_potential = models.CharField(
        max_length=10, choices=HR_SCORE_TYPE, blank=True, verbose_name="HR发展潜力"
    )
    hr_stability = models.CharField(
        max_length=10, choices=HR_SCORE_TYPE, blank=True, verbose_name="HR稳定性"
    )
    ...
    hr_result = models.CharField(
        max_length=256, choices=INTERVIEW_RESULT_TYPE, blank=True, verbose_name="HR复试结果"
    )
