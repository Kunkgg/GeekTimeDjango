# Generated by Django 4.0 on 2021-12-14 15:56
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_interviewer_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='first_interviewer_user', to='auth.user', verbose_name='面试官')),
                ('hr_interviewer_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='hr_interviewer_user', to='auth.user', verbose_name='HR面试官')),
                ('second_interviewer_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='second_interviewer_user', to='auth.user', verbose_name='二面面试官')),
            ],
            options={
                'verbose_name': '应聘者',
